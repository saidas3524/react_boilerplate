...
var _makeActionCreator = __webpack_require__(548);

Object.defineProperty(exports, 'makeActionCreator', {
  enumerable: true,
  get: function get() {
    return _makeActionCreator.makeActionCreator;
  }
});

var _createReducer = __webpack_require__(549);
...
var _getQuery = __webpack_require__(550);

Object.defineProperty(exports, 'getQuery', {
  enumerable: true,
  get: function get() {
    return _getQuery.getQuery;
  }
});

var _formatCurrency = __webpack_require__(553);
...
var _setCurrentUser = __webpack_require__(573);

Object.defineProperty(exports, 'setCurrentUser', {
  enumerable: true,
  get: function get() {
    return _setCurrentUser.setCurrentUser;
  }
});
Object.defineProperty(exports, 'SET_CURRENT_USER', {
  enumerable: true,
  get: function get() {
    return _setCurrentUser.SET_CURRENT_USER;
  }
});

var _getCurrentUserInfo = __webpack_require__(574);

Object.defineProperty(exports, 'getCurrentUserInfo', {
  enumerable: true,
  get: function get() {
    return _getCurrentUserInfo.getCurrentUserInfo;
  }
});
Object.defineProperty(exports, 'GET_CURRENT_USER_INFO', {
  enumerable: true,
  get: function get() {
    return _getCurrentUserInfo.GET_CURRENT_USER_INFO;
  }
});

var _setAccessToken = __webpack_require__(575);

Object.defineProperty(exports, 'setAccessToken', {
  enumerable: true,
  get: function get() {
    return _setAccessToken.setAccessToken;
  }
});
Object.defineProperty(exports, 'SET_ACCESS_TOKEN', {
  enumerable: true,
  get: function get() {
    return _setAccessToken.SET_ACCESS_TOKEN;
  }
});

var _setClaims = __webpack_require__(576);

Object.defineProperty(exports, 'setClaims', {
  enumerable: true,
  get: function get() {
    return _setClaims.setClaims;
  }
});
Object.defineProperty(exports, 'SET_CLAIMS', {
  enumerable: true,
  get: function get() {
    return _setClaims.SET_CLAIMS;
  }
});

var _setNavigationMenu = __webpack_require__(577);

Object.defineProperty(exports, 'setNavigationMenu', {
  enumerable: true,
  get: function get() {
    return _setNavigationMenu.setNavigationMenu;
  }
});
Object.defineProperty(exports, 'SET_NAVIGATION_MENU', {
  enumerable: true,
  get: function get() {
    return _setNavigationMenu.SET_NAVIGATION_MENU;
  }
});

var _setNewsFeed = __webpack_require__(578);

Object.defineProperty(exports, 'setNewsFeed', {
  enumerable: true,
  get: function get() {
    return _setNewsFeed.setNewsFeed;
  }
});
Object.defineProperty(exports, 'SET_NEWS_FEED', {
  enumerable: true,
  get: function get() {
    return _setNewsFeed.SET_NEWS_FEED;
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(245);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal_io__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__buffers__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(242);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _msalx = __webpack_require__(557);
...
var MSAL_Wrapper = function () {
    function MSAL_Wrapper() {
        var _this = this;

        _classCallCheck(this, MSAL_Wrapper);

        this.clientApplication = new _msalx.UserAgentApplication(applicationConfig.clientID, applicationConfig.authority, function (errorDesc, token, error, tokenType) {
            // debugger;
            // Called after loginRedirect or acquireTokenPopup
            if (tokenType == "id_token") {
                _this.userName = _this.clientApplication.getUser().name;
        ...
        this.getAccessToken = function () {
            return _this.clientApplication.acquireTokenSilent(applicationConfig.b2cScopes);
        };
    ...
    _createClass(MSAL_Wrapper, [{
        ...
        value: function loginPopup() {
            ...
            this.clientApplication.loginPopup(applicationConfig.b2cScopes).then(function (idToken) {
                _this2.clientApplication.acquireTokenSilent(applicationConfig.b2cScopes).then(function (accessToken) {
                    var userName = _this2.clientApplication.getUser().name;
                    //   this.setState({ isLoggedIn: true });
                    _this2.logMessage("User '" + userName + "' logged-in");
                }, function (error) {
                    _this2.clientApplication.acquireTokenPopup(applicationConfig.b2cScopes).then(function (accessToken) {
                        var userName = _this2.clientApplication.getUser().name;
                        //     this.setState({ isLoggedIn: true });
                        _this2.logMessage("User '" + userName + "' logged-in");
                    }, function (error) {
                        _this2.logMessage("Error acquiring the popup:\n" + error);
                    });
                });
            }, function (error) {
                _this2.logMessage("Error during login:\n" + error);
            });
        }
    }, {
        key: 'callApi',
        value: function callApi() {
            ...
            this.clientApplication.acquireTokenSilent(applicationConfig.b2cScopes).then(function (accessToken) {
                _this3.callApiWithAccessToken(accessToken);
            }, function (error) {
                _this3.clientApplication.acquireTokenPopup(applicationConfig.b2cScopes).then(function (accessToken) {
                    _this3.callApiWithAccessToken(accessToken);
                }, function (error) {
                    _this3.logMessage("Error acquiring the access token to call the Web api:\n" + error);
                });
            });
        }
    }, {
        key: 'callApiWithAccessToken',
        value: function callApiWithAccessToken(accessToken) {
            var _this4 = this;
            ...
            fetch(applicationConfig.webApi, {
                ...
                response.text().then(function (text) {
                    return _this4.logMessage("Web APi returned:\n" + JSON.stringify(text));
                });
            }).catch(function (result) {
                _this4.logMessage("Error calling the Web api:\n" + result);
            });
        }
    }]);
...
exports.default = new MSAL_Wrapper();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PathUtils__ = __webpack_require__(77);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_path_to_regexp__ = __webpack_require__(526);
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(InvokeUrl);

function InvokeUrl(url, method, data) {
    var accessToken, result, responseC;
    return regeneratorRuntime.wrap(function InvokeUrl$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.next = 2;
                    return (0, _effects.select)(_selectors.accessTokenSelector);
                ...
                case 2:
                    ...
                    _context.next = 6;
                    return (0, _effects.take)(_actions.SET_ACCESS_TOKEN);
                ...
                case 8:
                    _context.next = 10;
                    return (0, _effects.call)(_isomorphicFetch2.default, url, {
                        method: method,
                        headers: {
                ...
                case 10:
                    ...
                    return _context.abrupt("return", responseC);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matchPath__ = __webpack_require__(102);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HashRouter__ = __webpack_require__(529);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "HashRouter", function() { return __WEBPACK_IMPORTED_MODULE_1__HashRouter__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Link__ = __webpack_require__(240);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__StaticRouter__ = __webpack_require__(535);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "StaticRouter", function() { return __WEBPACK_IMPORTED_MODULE_9__StaticRouter__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Switch__ = __webpack_require__(536);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Switch", function() { return __WEBPACK_IMPORTED_MODULE_10__Switch__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__matchPath__ = __webpack_require__(537);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "matchPath", function() { return __WEBPACK_IMPORTED_MODULE_11__matchPath__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__withRouter__ = __webpack_require__(538);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Router__ = __webpack_require__(100);
...
var ErrorMessage_1 = __webpack_require__(155);
var XhrClient_1 = __webpack_require__(248);
...
var _currentUserSelector = __webpack_require__(580);

Object.defineProperty(exports, 'currentUserSelector', {
  enumerable: true,
  get: function get() {
    return _currentUserSelector.currentUserSelector;
  }
});

var _accessTokenSelector = __webpack_require__(581);

Object.defineProperty(exports, 'accessTokenSelector', {
  enumerable: true,
  get: function get() {
    return _accessTokenSelector.accessTokenSelector;
  }
});

var _newsFeedSelector = __webpack_require__(582);

Object.defineProperty(exports, 'newsFeedSelector', {
  enumerable: true,
  get: function get() {
    return _newsFeedSelector.newsFeedSelector;
  }
});
...
module.exports = __webpack_require__(607).ReactAI;
module.exports.TrackedComponent = __webpack_require__(611).TrackedComponent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createMemoryHistory__ = __webpack_require__(521);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history__ = __webpack_require__(522);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history_PathUtils__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history_PathUtils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_history_PathUtils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Router__ = __webpack_require__(100);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__proc__ = __webpack_require__(244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scheduler__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__io__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__channel__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__buffers__ = __webpack_require__(103);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(546);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Authority_1 = __webpack_require__(154);
var XhrClient_1 = __webpack_require__(248);
/**
* @hidden
*/
...
var _currentUser = __webpack_require__(588);
...
var _accessToken = __webpack_require__(589);
...
var _newsFeed = __webpack_require__(590);

Object.defineProperty(exports, 'newsFeed', {
  enumerable: true,
  get: function get() {
    return _newsFeed.newsFeed;
  }
});
...
var TextInput = function TextInput(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement('input', { type: 'text', name: name, className: 'form-control', readOnly: readonly, placeholder: placeholder, value: value, onChange: onChange }),
...
var xtend = __webpack_require__(609);
...
var $export = __webpack_require__(0);
var toISOString = __webpack_require__(367);
...
$export($export.P + $export.F * (__webpack_require__(73) != Object || !__webpack_require__(28)(arrayJoin)), 'Array', {
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(0);
var $pad = __webpack_require__(207);
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(0);
var scale = __webpack_require__(211);
...
$export($export.S, 'Math', { scale: __webpack_require__(211) });
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(487)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var _getStore = __webpack_require__(540);

var _routes = __webpack_require__(592);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBrowserHistory__ = __webpack_require__(523);
/* unused harmony reexport createBrowserHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(524);
/* unused harmony reexport createHashHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__ = __webpack_require__(525);
/* unused harmony reexport createMemoryHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LocationUtils__ = __webpack_require__(101);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__LocationUtils__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__LocationUtils__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PathUtils__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LocationUtils__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PathUtils__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__createTransitionManager__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DOMUtils__ = __webpack_require__(234);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_warning__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_warning___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_warning__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PathUtils__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LocationUtils__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__createTransitionManager__ = __webpack_require__(148);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createHashHistory__ = __webpack_require__(530);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Route__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Link__ = __webpack_require__(240);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_matchPath__ = __webpack_require__(102);
// Written in this round about way for babel-transform-imports
...
var _reduxLogger = __webpack_require__(541);

var _immutable = __webpack_require__(29);

var _reduxSaga = __webpack_require__(542);
...
var _utility = __webpack_require__(38);

var _initSagas = __webpack_require__(554);

var _combineReducers = __webpack_require__(587);

var _defaultState = __webpack_require__(591);
...
var getStore = exports.getStore = function getStore() {
    ...
    var middleWares = [sagaMiddleware, _reduxThunk2.default];
    if ((0, _utility.getQuery)()['logger']) {
        middleWares.push(logger);
    }
    var composables = [_redux.applyMiddleware.apply(undefined, middleWares)
    //    , window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()
    ];
    var enhancer = _redux.compose.apply(undefined, composables);
    var store = (0, _redux.createStore)(_combineReducers.reducer, _defaultState.defaultState, enhancer);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal_middleware__ = __webpack_require__(543);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__internal_runSaga__ = __webpack_require__(243);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__internal_channel__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__internal_buffers__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__internal_sagaHelpers__ = __webpack_require__(245);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__internal_utils__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__internal_io__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils__ = __webpack_require__(547);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__channel__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runSaga__ = __webpack_require__(243);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fsmIterator__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__buffers__ = __webpack_require__(103);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal_utils__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__internal_io__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__internal_proc__ = __webpack_require__(244);
...
var getQuery = exports.getQuery = function getQuery() {
  return typeof window !== 'undefined' ? __webpack_require__(551).parse(location.search) : {};
};
...
var strictUriEncode = __webpack_require__(552);
...
var _sagas = __webpack_require__(555);

var sagas = _interopRequireWildcard(_sagas);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var initSagas = exports.initSagas = function initSagas(sagaMiddleware) {
...
var _currentUserSaga = __webpack_require__(556);

Object.defineProperty(exports, 'currentUserSaga', {
  enumerable: true,
  get: function get() {
    return _currentUserSaga.currentUserSaga;
  }
});

var _claimsSaga = __webpack_require__(583);

Object.defineProperty(exports, 'claimsSaga', {
  enumerable: true,
  get: function get() {
    return _claimsSaga.claimsSaga;
  }
});

var _navigationMenuSaga = __webpack_require__(584);

Object.defineProperty(exports, 'navigationMenuSaga', {
  enumerable: true,
  get: function get() {
    return _navigationMenuSaga.navigationMenuSaga;
  }
});

var _accessTokenSaga = __webpack_require__(585);

Object.defineProperty(exports, 'accessTokenSaga', {
  enumerable: true,
  get: function get() {
    return _accessTokenSaga.accessTokenSaga;
  }
});

var _newsFeedSaga = __webpack_require__(586);

Object.defineProperty(exports, 'newsFeedSaga', {
  enumerable: true,
  get: function get() {
    return _newsFeedSaga.newsFeedSaga;
  }
});
...
exports.currentUserSaga = currentUserSaga;

var _effects = __webpack_require__(62);

var _immutable = __webpack_require__(29);

var _msal_wrapper = __webpack_require__(78);

var _msal_wrapper2 = _interopRequireDefault(_msal_wrapper);

var _actions = __webpack_require__(40);

var _utilitySagas = __webpack_require__(104);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _marked = /*#__PURE__*/regeneratorRuntime.mark(currentUserSaga);
//import fetch from 'isomorphic-fetch';

function currentUserSaga() {
    var responseC, UserData, data;
    return regeneratorRuntime.wrap(function currentUserSaga$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.next = 2;
                    return (0, _effects.call)(_utilitySagas.InvokeUrl, 'https://localhost/MS.IT.Oem.Provisioning.NavigationAndProfile.WebApi/GetUserInfo', 'GET');
                ...
                case 5:
                    ...
                    data = (0, _immutable.fromJS)({ user: UserData });
                    _context.next = 10;
                    return (0, _effects.put)((0, _actions.setCurrentUser)(data));
...
Object.defineProperty(exports, "__esModule", { value: true });
var RequestContext_1 = __webpack_require__(560);
var User_1 = __webpack_require__(562);
var Storage_1 = __webpack_require__(563);
var Utils_1 = __webpack_require__(39);
var Constants_1 = __webpack_require__(153);
var AuthenticationRequestParameters_1 = __webpack_require__(565);
var Constants_2 = __webpack_require__(153);
var IdToken_1 = __webpack_require__(566);
var ClientInfo_1 = __webpack_require__(567);
var RequestInfo_1 = __webpack_require__(568);
var AccessTokenKey_1 = __webpack_require__(569);
var AccessTokenValue_1 = __webpack_require__(570);
var AuthorityFactory_1 = __webpack_require__(571);
/**
* @hidden
*/
var ResponseTypes = {
...
Object.defineProperty(exports, "__esModule", { value: true });
var Logger_1 = __webpack_require__(561);
/**
* @hidden
*/
...
Object.defineProperty(exports, "__esModule", { value: true });
var AccessTokenCacheItem_1 = __webpack_require__(564);
var Constants_1 = __webpack_require__(153);
/**
* @hidden
*/
...
Object.defineProperty(exports, "__esModule", { value: true });
var Utils_1 = __webpack_require__(39);
var AadAuthority_1 = __webpack_require__(247);
var B2cAuthority_1 = __webpack_require__(572);
var Authority_1 = __webpack_require__(154);
var ErrorMessage_1 = __webpack_require__(155);
...
exports.setCurrentUser = exports.SET_CURRENT_USER = undefined;

var _utility = __webpack_require__(38);

var SET_CURRENT_USER = exports.SET_CURRENT_USER = "SET_CURRENT_USER";
var setCurrentUser = exports.setCurrentUser = (0, _utility.makeActionCreator)(SET_CURRENT_USER, "user");
...
exports.getCurrentUserInfo = exports.GET_CURRENT_USER_INFO = undefined;

var _utility = __webpack_require__(38);

var GET_CURRENT_USER_INFO = exports.GET_CURRENT_USER_INFO = "GET_CURRENT_USER_INFO";
var getCurrentUserInfo = exports.getCurrentUserInfo = (0, _utility.makeActionCreator)(GET_CURRENT_USER_INFO, "");
...
exports.setAccessToken = exports.SET_ACCESS_TOKEN = undefined;

var _utility = __webpack_require__(38);

var SET_ACCESS_TOKEN = exports.SET_ACCESS_TOKEN = "SET_ACCESS_TOKEN";
var setAccessToken = exports.setAccessToken = (0, _utility.makeActionCreator)(SET_ACCESS_TOKEN, "accessToken");
...
exports.setClaims = exports.SET_CLAIMS = undefined;

var _utility = __webpack_require__(38);

var SET_CLAIMS = exports.SET_CLAIMS = "SET_CLAIMS";
var setClaims = exports.setClaims = (0, _utility.makeActionCreator)(SET_CLAIMS, "claims");
...
exports.setNavigationMenu = exports.SET_NAVIGATION_MENU = undefined;

var _utility = __webpack_require__(38);

var SET_NAVIGATION_MENU = exports.SET_NAVIGATION_MENU = "SET_NAVIGATION_MENU";
var setNavigationMenu = exports.setNavigationMenu = (0, _utility.makeActionCreator)(SET_NAVIGATION_MENU, "navigationMenu");
...
exports.setNewsFeed = exports.SET_NEWS_FEED = undefined;

var _utility = __webpack_require__(38);

var SET_NEWS_FEED = exports.SET_NEWS_FEED = "SET_NEWS_FEED";
var setNewsFeed = exports.setNewsFeed = (0, _utility.makeActionCreator)(SET_NEWS_FEED, "newsFeed");
...
var _reselect = __webpack_require__(157);

var currentUserSelector = exports.currentUserSelector = (0, _reselect.createSelector)(function (state) {
...
exports.accessTokenSelector = undefined;

var _reselect = __webpack_require__(157);

var accessTokenSelector = exports.accessTokenSelector = (0, _reselect.createSelector)(function (state) {
...
exports.newsFeedSelector = undefined;

var _reselect = __webpack_require__(157);

var newsFeedSelector = exports.newsFeedSelector = (0, _reselect.createSelector)(function (state) {
   return state.get('newsFeed');
}, function (newsFeed) {
   return newsFeed;
});
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(claimsSaga);

function claimsSaga() {
    var responseC, claimsData;
    return regeneratorRuntime.wrap(function claimsSaga$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _effects.call)(_utilitySagas.InvokeUrl, 'https://api.microsoftoem.net/Companyaad/royd/v1/GetClaims', 'GET');
...
exports.navigationMenuSaga = navigationMenuSaga;
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(navigationMenuSaga);

function navigationMenuSaga() {
    var _ref, accessToken, response, navData, data;

    return regeneratorRuntime.wrap(function navigationMenuSaga$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                ...
                case 3:
                    ...
                    _context.next = 7;
                    return (0, _effects.call)(_utilitySagas.InvokeUrl, 'https://api.microsoftoem.net/Companyaad/royd/v1/GetNavigation', 'GET');

                case 7:
                    response = _context.sent;
                    _context.next = 10;
                    return (0, _effects.apply)(response, response.json);
                ...
                case 10:
                    ...
                    _context.next = 14;
                    return (0, _effects.put)((0, _actions.setNavigationMenu)(navData));
                    ...
                    data = (0, _immutable.fromJS)({
                        user: {
                            ...
                            newsFeed: [{
                                ...
                                message: "test message test message test messagetest message test messagetest message test" + " messagetest message test message test message test message test messagetest mes" + "sage test messagetest message test messagetest message test messagetest message " + "test message test messagetest message test messagetest message test messagetest " + "message test messagetest message test message test messagetest message test mess" + "agetest message test messagetest message test messagetest message test message t" + "est messagetest message test messagetest message test messagetest message test m" + "essage"
                            }, {
                                Id: "2",
                                title: "Microsoft Hike3s",
                                message: "test test message test message test messagetest message test messagetest message" + " test messagetest message test messagetest message test message test messagetest" + " message test messagetest message test messagetest message test messagetest mess" + "age test message test messagetest message test messagetest message test messaget" + "est message test messagemessage test message test messagetest message test messa" + "getest message test messagetest message test message"
                            }, {
                                Id: "3",
                                title: "Microsoft Hike4s",
                                message: "test message testtest message test message test messagetest message test message" + "test message test messagetest message test messagetest message test message test" + " messagetest message test messagetest message test messagetest message test mess" + "agetest message test message test messagetest message test messagetest message t" + "est messagetest message test message message test messagetest message test messa" + "getest message test messagetest message test message"
                            }]
                        }
                    });
                ...
                case 17:
                    ...
                    _msal_wrapper2.default.loginRedirect();
                    throw _context.t0;
...
exports.accessTokenSaga = accessTokenSaga;
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(accessTokenSaga);
//import fetch from 'isomorphic-fetch';

function accessTokenSaga() {
    var _ref, id, accessToken;

    return regeneratorRuntime.wrap(function accessTokenSaga$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    console.log("access token  saga Invoked");
                    _context.next = 3;
                    return (0, _effects.take)(_actions.GET_CURRENT_USER_INFO);
                ...
                case 3:
                    ...
                    _context.prev = 5;
                    _context.next = 8;
                    return (0, _effects.call)(_msal_wrapper2.default.getAccessToken);
                ...
                case 8:
                    ...
                    _context.next = 12;
                    return (0, _effects.put)((0, _actions.setAccessToken)(accessToken));
...
exports.newsFeedSaga = newsFeedSaga;
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(newsFeedSaga);

function newsFeedSaga() {
    var _ref, UserID, responseC, newsFeed;

    return regeneratorRuntime.wrap(function newsFeedSaga$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _effects.take)(_actions.SET_CURRENT_USER);

                case 3:
                    _ref = _context.sent;
                    UserID = _ref.UserID;
                    _context.next = 7;
                    return (0, _effects.call)(_utilitySagas.InvokeUrl, "https://localhost/MS.IT.Oem.Provisioning.NavigationAndProfile.WebApi/GetMessagesById?userId=" + UserID, 'GET');
                ...
                case 10:
                    ...
                    _context.next = 14;
                    return (0, _effects.put)((0, _actions.setNewsFeed)(newsFeed));
...
exports.reducer = exports.combineReducers = undefined;
...
var combineReducers = exports.combineReducers = function combineReducers(config) {

    var defaultState = (0, _immutable.fromJS)(Object.keys(config).reduce(function (a, key) {
    ...
    return function () {
        ...
        return Object.keys(config).reduce(function (state, key) {
            ...
            var previousState = state.get(key);
            var newValue = reducer(previousState, action);
...
var reducer = exports.reducer = combineReducers(reducers);
...
var currentUser = exports.currentUser = (0, _utility.createReducer)(null, _defineProperty({}, _actions.SET_CURRENT_USER, function (state, _ref) {
    var user = _ref.user;

    return (0, _immutable.fromJS)(user);
}));
...
var accessToken = exports.accessToken = (0, _utility.createReducer)(null, _defineProperty({}, _actions.SET_ACCESS_TOKEN, function (state, _ref) {
    var accessToken = _ref.accessToken;

    return (0, _immutable.fromJS)(accessToken);
}));
...
var newsFeed = exports.newsFeed = (0, _utility.createReducer)(null, _defineProperty({}, _actions.SET_NEWS_FEED, function (state, _ref) {
    var newsFeed = _ref.newsFeed;

    return (0, _immutable.fromJS)(newsFeed);
}));
...
var defaultState = exports.defaultState = (0, _immutable.fromJS)({
    currentUser: null,
    user: null
});
...
var _reactCodeSplitting = __webpack_require__(596);

var _reactCodeSplitting2 = _interopRequireDefault(_reactCodeSplitting);

var _AsyncComponent = __webpack_require__(597);

var _AsyncComponent2 = _interopRequireDefault(_AsyncComponent);

__webpack_require__(598);

var _Locale = __webpack_require__(599);

var _Locale2 = _interopRequireDefault(_Locale);

var _UserProfile = __webpack_require__(602);

var _UserProfile2 = _interopRequireDefault(_UserProfile);

var _WelcomePage = __webpack_require__(604);
...
var TrackedComponent = __webpack_require__(159).TrackedComponent;

var App = function (_TrackedComponent) {
    _inherits(App, _TrackedComponent);
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            _get(App.prototype.__proto__ || Object.getPrototypeOf(App.prototype), 'componentWillMount', this).call(this);
            setTimeout(function () {
                console.log("user Name Inside:" + _msal_wrapper2.default.userName);
                //  debugger;       
            ...
            console.log("user Name :" + _msal_wrapper2.default.userName);
        }
    }, {
        key: 'getChildContext',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: { minHeight: "1000px" }, className: 'container-fluid' },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        getCurrentUserInfo: function getCurrentUserInfo() {
            dispatch((0, _actions.getCurrentUserInfo)('test'));
        }
    };
};
...
var _LocaleHOC = __webpack_require__(158);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { to: '/user' },
                        _react2.default.createElement(_Avatar2.default, { className: 'avatar_div', user: this.state.user })
                    )
                )
            );
        }
...
!function(e,t){ true?module.exports=t(__webpack_require__(1),__webpack_require__(3)):"function"==typeof define&&define.amd?define(["react","prop-types"],t):"object"==typeof exports?exports.ReactCodeSplitting=t(require("react"),require("prop-types")):e.ReactCodeSplitting=t(e.react,e["prop-types"])}(this,function(e,t){return function(e){function t(o){if(n[o])return n[o].exports;var r=n[o]={i:o,l:!1,exports:{}};return e[o].call(r.exports,r,r.exports,t),r.l=!0,r.exports}var n={};return t.m=e,t.c=n,t.d=function(e,n,o){t.o(e,n)||Object.defineProperty(e,n,{configurable:!1,enumerable:!0,get:o})},t.n=function(e){var n=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(n,"a",n),n},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="/",t(t.s=0)}([function(e,t,n){"use strict";function o(e){return e&&e.__esModule?e:{default:e}}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function c(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0});var p=n(1),i=o(p),a=n(2),f=o(a),l=function(e){function t(){var e,n,o,c,p=this;r(this,t);for(var a=arguments.length,f=Array(a),l=0;l<a;l++)f[l]=arguments[l];return n=o=u(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(f))),o.componentWillMount=function(){o.cancelUpdate=!1,o.props.load.then(function(e){o.C=e,o.cancelUpdate||o.forceUpdate()})},o.componentWillUnmount=function(){o.cancelUpdate=!0},o.render=function(){var e=o.props.componentProps;return o.C?o.C.default?i.default.createElement(p.C.default,e):i.default.createElement(p.C,e):null},c=n,u(o,c)}return c(t,e),t}(i.default.Component);t.default=l,l.propTypes={load:f.default.instanceOf(Promise).isRequired}},function(t,n){t.exports=e},function(e,n){e.exports=t}])});
//# sourceMappingURL=react-code-splitting.min.js.map
...
var _enUs = __webpack_require__(600);

var _enUs2 = _interopRequireDefault(_enUs);

var _enUk = __webpack_require__(601);
...
module.exports = {"HeaderName":"Digital Operations Center","Headerpara":"UxModernisation","FooterName":"","Footerpara":"","ContactUs":"Contact us","TradeMarks":"Trademarks","PrivacyTerms":"Privacy & Cookies","TermsOfUse":"Terms of use","WelcomeMessage":"From this HOme page you can access the specific Microsoft OEm Operations applications you use for your job function . Just select an application from one of the fucntional areas listed in the menu","WelcomeMessage2":"You can also view current notifications in the News and Information area below. if you need help you can contact us"}

/***/ }),
/* 601 */
/***/ (function(module, exports) {

module.exports = {"HeaderName":"Digital Operations Center-Uk","Headerpara":"UxModernisation-Uk","FooterName":"","Footerpara":"","ContactUs":"Uk-Contact us","TradeMarks":"Uk-Trademarks","PrivacyTerms":"Uk-Privacy & Cookies","TermsOfUse":"Uk-Terms of use","WelcomeMessage":"UK-From this HOme page you can access the specific Microsoft OEm Operations applications you use for your job function . Just select an application from one of the fucntional areas listed in the menu","WelcomeMessage2":"Uk-You can also view current notifications in the News and Information area below. if you need help you can contact us"}
...
var _TextInput = __webpack_require__(251);
...
var _UserReadOnlyProfile = __webpack_require__(603);

var _UserReadOnlyProfile2 = _interopRequireDefault(_UserReadOnlyProfile);
...
var UserProfile = function (_Component) {
    ...
    function UserProfile(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (UserProfile.__proto__ || Object.getPrototypeOf(UserProfile)).call(this, props, context));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: { backgroundColor: "#f2f2f2", marginBottom: "15px", paddingBottom: "15px" }, className: 'col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3  col-sm-6 col-xs-12' },
                        _react2.default.createElement(
                            'div',
                            { style: { margin: "20px" } },
                            _react2.default.createElement(_UserReadOnlyProfile2.default, { user: user }),
                            _react2.default.createElement('br', null),
                            _react2.default.createElement(
                                'h4',
                                null,
                            ...
                            _react2.default.createElement(_TextInput2.default, { readonly: false, name: 'Name', label: 'Name', value: user.name }),
                            _react2.default.createElement(_TextInput2.default, { readonly: true, name: 'LastName', label: 'Last Name', value: user.lastName }),
                            _react2.default.createElement(_TextInput2.default, { readonly: true, name: 'ContactEmail', label: 'Contact Email', value: user.contactEmail }),
                            _react2.default.createElement('hr', null),
                            _react2.default.createElement(
                                'div',
                                { className: 'span2' },
...
var UserReadOnlyProfile = function UserReadOnlyProfile(_ref) {
    var user = _ref.user;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'profileCircle center-block' },
            _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('span', { className: 'glyphicon glyphicon-user', 'aria-hidden': 'false', style: { fontSize: '50px' } })
            )
        ),
        _react2.default.createElement(
            'h4',
        ...
        _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_TextInput2.default, { readonly: true, name: 'Name', label: 'Name', value: user.name }),
            _react2.default.createElement(_TextInput2.default, { readonly: true, name: 'LastName', label: 'Last Name', value: user.lastName }),
            _react2.default.createElement(_TextInput2.default, { readonly: true, name: 'ContactEmail', label: 'Contact Email', value: user.contactEmail })
        )
    );
...
exports.default = UserReadOnlyProfile;
...
var _NewsFeed = __webpack_require__(605);
            ...
            return _react2.default.createElement(
                ...
                user && _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'row' },
                        _react2.default.createElement('h2', { className: 'col-xs-12' }),
                        _react2.default.createElement(
                            'p',
                            { className: 'col-xs-12' },
                            locale.strings.WelcomeMessage,
                            _react2.default.createElement('br', null),
                            locale.strings.WelcomeMessage2
                        )
                    ),
                    _react2.default.createElement(_NewsFeed2.default, { newsFeed: newsFeed })
                )
            );
        }
    }]);
...
var mapStateToProps = function mapStateToProps(state) {
    var user = (0, _selectors.currentUserSelector)(state);
    var newsFeed = (0, _selectors.newsFeedSelector)(state);
    // if(user != null)
    // {
    //     user = user.toJS();
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _LocaleHOC2.default)(WelcomePage));
...
var _NewsCard = __webpack_require__(606);
...
var NewsFeed = function NewsFeed(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'row' },
        newsFeed && _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
                'h3',
            ...
            _react2.default.createElement(
                ...
                newsFeed.map(function (news) {
                    return _react2.default.createElement(_NewsCard2.default, { key: news.MessageId, news: news });
                })
            )
        )
    );
...
var _applicationinsightsJs = __webpack_require__(160);

var _appinsightsUsage = __webpack_require__(608);
...
var _away = __webpack_require__(252);

var _away2 = _interopRequireDefault(_away);

var _removeValue = __webpack_require__(610);
...
//# sourceMappingURL=bundle.49cc3207baf2e6c200e6.js.map